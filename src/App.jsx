      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          <div className="animate-fade-in-up">
            <img src="https://github.com/ABHAI-TIWARI/abhai-tiwari/blob/main/src/assets/WhatsApp%20Image%202024-01-17%20at%2011.44.58%20AM.jpeg" alt="Abhai Tiwari" className="w-48 h-48 rounded-full mx-auto mb-6 object-cover" />
